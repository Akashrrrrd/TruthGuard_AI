              ...
              <div className="container mx-auto px-4">
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <Link href="/search" className="flex items-center space-x-1 text-sm hover:text-blue-600">
                      <Search className="h-4 w-4" />
                      <span>Search</span>
                    </Link>
                    <Link href="/analyze" className="flex items-center space-x-1 text-sm hover:text-blue-600">
                      <Zap className="h-4 w-4" />
                      <span>Analyze</span>
                    </Link>
                    <Link href="/trends" className="flex items-center space-x-1 text-sm hover:text-blue-600">
